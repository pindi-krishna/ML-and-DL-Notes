...
1. [Video to be watched](https://www.youtube.com/watch?v=vTY58-51XZA)
...
[Blog](https://towardsdatascience.com/interpretable-neural-networks-45ac8aa91411)
...
1. Specifically, for the ith feature of a specific data point, the feature’s contribution to the model output is $w_i \times x_i$. What does this weight w represent? Well, since a regression is $$Y = w_1 \times x_1 + w_2 \times x_2 + ........+ w_n \times x_n + b$$ Then, $$w_i = \frac{\partial Y}{\partial x_i}$$
